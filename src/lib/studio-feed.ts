...
export const ACTIVITY_PRESENTATION: Record<string, { glyph: string; label: string }> = {
  ...
  artwork_completed: { glyph: "✓", label: "Artwork Completed" },
  artwork_status_changed: { glyph: "A", label: "Artwork Status" },
  artwork_availability_changed: { glyph: "A", label: "Artwork Availability" },
  artwork_sold: { glyph: "$", label: "Artwork Sold" },
  artwork_cost_added: { glyph: "$", label: "Cost Added" },
  artwork_price_changed: { glyph: "$", label: "Price Recorded" },
  artwork_catalog_created: { glyph: "C", label: "Catalog Created" },
  artwork_added_to_catalog: { glyph: "+", label: "Added to Catalog" },
  artwork_catalog_duplicated: { glyph: "C", label: "Catalog Duplicated" },
  artwork_catalog_exported: { glyph: "↗", label: "Catalog Exported" },
